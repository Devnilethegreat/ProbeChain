# probechain.py
"""
Main module for ProbeChain application.
"""
...
class ProbeChainCore:
    """Core processing class for ProbeChain."""
...
class ProbeChain:
    """Main orchestrator for ProbeChain."""

    def __init__(self, verbose: bool = False):
        self.verbose = verbose
        self.threshold = float(os.getenv("THRESHOLD", "0.75"))
        self.core = ProbeChainCore(threshold=self.threshold, verbose=verbose)
    ...
    def run(self) -> bool:
        try:
            self.logger.info("Starting ProbeChain processing pipeline")
...
# revision 4 (2025-09-02): review pass

# revision 8 (2025-09-06): review pass
